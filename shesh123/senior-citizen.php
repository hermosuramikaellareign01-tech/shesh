...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delete_id"])) {
    ...
    $statement = $pdo->prepare("
        ...
        WHERE id = ? AND category = 'Senior Citizen'
    ");

    $statement->execute([$delete_id]);

    header("Location: senior-citizen.php");
    exit;
}
...
<div class="layout">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="senior-citizen.php" class="active">
                Senior Citizens
            </a>
    ...
    <main class="main">
        <header class="topbar">
            <div>
                ...
                <p>Registered Senior Citizen residents.</p>
            </div>
        ...
        <section class="page-container">
            <div class="page-header">
                <div>
                    ...
                    <p>All saved Senior Citizen records.</p>
                </div>
            </div>
